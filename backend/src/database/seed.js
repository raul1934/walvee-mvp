...
const TRIPS = [
  {
    ...
    description:
      "Experience the perfect blend of ancient traditions and futuristic innovation in Japan's vibrant capital. From serene temples to bustling fish markets, this 7-day journey will immerse you in authentic Japanese culture.",
    duration: "7 days",
    budget: "$$$$",
        ...
        activities: [
          {
            ...
            location: "Shibuya",
            description:
              "Settle into your boutique hotel in the heart of Shibuya",
          },
          {
            time: "16:00",
      ...
      },
      {
        ...
        activities: [
          ...
          },
          {
            ...
            name: "Tokyo Skytree",
            location: "Sumida",
            description: "Ascend Japan's tallest structure",
          },
        ],
      },
      {
        ...
        activities: [
          ...
          },
          {
            ...
            location: "Akihabara",
            description: "Unique Japanese pop culture experience",
          },
          {
            time: "19:00",
            name: "Yakitori Dinner",
            location: "Yurakucho",
            description: "Grilled chicken skewers under the railway tracks",
          },
        ],
      },
    ],
    places: [
      {
        ...
        description:
          "Tokyo's oldest temple, featuring stunning architecture and traditional atmosphere",
      },
      {
        name: "Shibuya Crossing",
  ...
  },
  {
    ...
    description:
      "Experience the city of love with this perfect 5-day romantic itinerary. Stroll along the Seine, savor croissants at charming cafes, and witness the Eiffel Tower sparkle at night.",
    duration: "5 days",
    budget: "$$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            location: "Trocadéro",
            description: "Watch the Eiffel Tower light show",
          },
        ],
      },
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description: "Contemporary French cuisine",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Find inner peace and rejuvenation in Bali's spiritual heart. This 10-day retreat combines yoga, meditation, healthy cuisine, and cultural exploration in the lush rice terraces of Ubud.",
    duration: "10 days",
    budget: "$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          {
            time: "14:00",
            name: "Check-in at Wellness Resort",
            location: "Ubud",
          ...
          },
          {
            ...
            description: "Farm-to-table Balinese cuisine",
          },
        ],
      },
      {
        ...
        activities: [
          ...
          },
          {
            ...
            location: "Resort",
            description: "Smoothie bowls and tropical fruits",
          },
          {
            time: "10:00",
  ...
  },
  {
    ...
    description:
      "The ultimate introduction to the Big Apple! Experience iconic landmarks, world-class museums, diverse neighborhoods, and the unmatched energy that makes NYC one of the greatest cities on Earth.",
    duration: "6 days",
    budget: "$$$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description: "Walk across this historic bridge",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    destination: "Iceland",
    description:
      "Drive the complete Ring Road and discover Iceland's raw natural beauty. From glaciers and waterfalls to hot springs and black sand beaches, this 14-day road trip is an adventure of a lifetime.",
    duration: "14 days",
    budget: "$$$",
        ...
        activities: [
          {
            ...
            location: "Reykjavik",
            description: "Get your 4WD vehicle",
          },
          {
            time: "10:30",
  ...
  },
  {
    ...
    description:
      "Discover Gaudí's masterpieces, feast on endless tapas, and soak up the Mediterranean sun. This 5-day itinerary perfectly balances culture, food, and beach time in Catalonia's vibrant capital.",
    duration: "5 days",
    budget: "$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description: "Sample pintxos and vermouth",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Trek through some of the world's most dramatic landscapes in Argentine and Chilean Patagonia. This 12-day expedition takes you to towering granite peaks, turquoise lakes, and massive glaciers.",
    duration: "12 days",
    budget: "$$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          {
            time: "14:00",
            name: "Arrive in El Chaltén",
            location: "El Chaltén",
            description: "Check into hostel and get hiking permits",
          },
          {
            time: "16:00",
            name: "Gear Check",
            location: "El Chaltén",
            description: "Organize hiking equipment and supplies",
          },
          {
            time: "18:00",
            name: "Trek Briefing",
            location: "Hostel",
            description: "Meet guide and review trail maps",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Eat your way through Vietnam on this ultimate culinary adventure. From pho in Hanoi to banh mi in Hoi An, experience the incredible diversity of Vietnamese street food culture.",
    duration: "15 days",
    budget: "$",
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            location: "Old Quarter",
            description: "Sample 10+ local specialties",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Experience the ultimate blend of luxury and adventure in Dubai. From world-record skyscrapers and luxury shopping to desert safaris and traditional souks, this 5-day trip has it all.",
    duration: "5 days",
    budget: "$$$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          ...
          },
          {
            ...
            description: "Tea at the iconic sail-shaped hotel",
          },
          {
            time: "20:00",
            name: "Fountain Show",
  ...
  },
  {
    ...
    description:
      "Sail through the stunning Greek islands discovering whitewashed villages, crystal-clear waters, ancient ruins, and legendary sunsets. This 10-day journey covers the best of the Cyclades.",
    duration: "10 days",
    budget: "$$$",
    ...
    itinerary: [
      {
        ...
        activities: [
          {
            time: "14:00",
            name: "Arrive in Santorini",
            location: "Fira",
            description: "Ferry from Athens and check-in",
          },
          {
            time: "16:00",
            name: "Explore Fira",
...
const seedData = async () => {
  ...
  try {
    ...
    // Create or get Walvee user
    console.log("\n🚀 Setting up Walvee user account...");
    ...
    if (existingUsers.length > 0) {
      ...
      console.log(`ℹ️  Walvee user already exists with ID: ${userId}`);
    } else {
      ...
      await connection.query(
        ...
        [
          userId,
          WALVEE_USER.email,
          WALVEE_USER.full_name,
          WALVEE_USER.preferred_name,
    ...
    for (let i = 0; i < TRIPS.length; i++) {
      ...
      console.log(
        `\n📍 Creating trip ${i + 1}/${TRIPS.length}: ${tripData.title}`
      );
      ...
      try {
        ...
        if (tripData.tags && tripData.tags.length > 0) {
          for (const tag of tripData.tags) {
            await connection.query(
              ...
              [generateUUID(), tripId, tag]
            );
          }
          console.log(`   🏷️  Tags: ${tripData.tags.join(", ")}`);
        }
        ...
        if (tripData.places && tripData.places.length > 0) {
          ...
          console.log(`   📍 Places: ${tripData.places.length} locations`);
        }
        ...
        if (tripData.itinerary && tripData.itinerary.length > 0) {
          for (const day of tripData.itinerary) {
            ...
            await connection.query(
              `INSERT INTO trip_itinerary_days (id, trip_id, day_number, title)
               VALUES (?, ?, ?, ?)`,
              [dayId, tripId, day.day, day.title]
            );
          ...
          console.log(`   📅 Itinerary: ${tripData.itinerary.length} days`);
        }

        tripCount++;
      } catch (error) {
        console.error(
          `   ❌ Error creating trip "${tripData.title}":`,
          error.message
        );
      }
    }
